    ...
    <div id="page-landing">
        <main id="page-landing-main">
            ...
            <section className="content" >
                <button type="button" className="btn btn-primary btn-lg"><Link to="/mapa">Busque Ponto <FiArrowRight/></Link></button>
                
                <p>Encontre estabelecimentos que<br/> fazem parte da economia circular e <br/>são pontos de coleta de resíduos <br/>sólidos.</p>
            </section>

            <section className="content">
                <button type="button" className="btn btn-primary btn-lg"><Link to="/cadastro">Cadastre Ponto <FiArrowRight/></Link> </button>
